...
\cvitem{Jun 2024}{\textbf{ICAPS24 DC Reimbursement}, Banff, Canada. I was awarded a 300 euros reimbursement for the participation in ICAPS24 DC.}
...
\section{Skills}
  \cvitem{Programming Languages}{%
    \begin{tabular}{l}
      \multirow{2}{*}{C, C++, Python, Prolog, CPLEX, Matlab, R, Latex, Java, Bash, JavaScript, PolyML}
    \end{tabular}
  }
  \cvitem{Technologies}{%
